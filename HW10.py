...
if T > F_crit:
    print('Так как T>F_crit, отличие среднего роста спортсменов является статистически значимым')
else:
    print('Так как T<F_crit, отличие среднего роста спортсменов не является статистически значимым')